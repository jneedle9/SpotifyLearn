...
import { HeartIcon, HomeIcon, VolumeDownIcon, VolumeOffIcon } from '@heroicons/react/outline'
...
function Player() {
  ...
  return (
    <div className='h-24 bg-gradient-to-b from-black to-gray-900 text-white grid grid-cols-3 tx-xs md:text-base px-2 md:px-8'>
        ...
        <div className='flex items-center space-x-3 md:space-x-4 justify-end pr-5'>
              ...
              <HomeIcon className='button' onClick={()=>volume < 100 && volume + 10}/>
        </div>
    </div>
  )
}
